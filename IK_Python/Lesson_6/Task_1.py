...
min_dist_vertexes. написать 3 варианта кода (один у вас уже есть); проанализировать 3 варианта и выбрать оптимальный;
...
"""
3.7.3 (default, Mar 27 2019, 17:13:21) [MSC start.1915 64 bit (AMD64)] win32
